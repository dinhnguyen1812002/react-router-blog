...
import { Clock3, Eye, ArrowLeft, User, MessageSquareText, CalendarDays } from "lucide-react";
  ...
  return (
    <MainLayout>
      ...
      <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
        ...
        {/* Article */}
        <article ref={articleRef} className="container max-w-5xl mx-auto px-4 pb-24 pt-12 sm:px-6">
          <header className="mb-12">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 font-mono">
              <span className="flex items-center gap-2">
                {authorAvatar ? (
                  <img src={authorAvatar} alt={authorName} className="w-8 h-8 object-cover" />
                ) : (
          ...
          <footer className="space-y-12">
            ...
            <div className="border border-black dark:border-white p-6 md:p-8 flex flex-col md:flex-row gap-6 items-start md:items-center">
              {authorAvatar ? (
                <img src={authorAvatar} alt={authorName} className="w-16 h-16 object-cover" />
              ) : (
              ...
              <div className="flex-1">
                <p className="text-xs uppercase tracking-widest text-gray-500 mb-1">Được viết bởi</p>
                <p className="text-xl font-serif mb-2">{authorName}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Tác giả tập trung chia sẻ những góc nhìn sâu sắc về công nghệ, thiết kế và cuộc sống.
                </p>
              </div>
            </div>
