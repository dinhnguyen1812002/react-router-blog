...
import { BarChart3, Mail, Plus, Send, Users } from "lucide-react";
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					<div className="flex items-start space-x-3">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-400">
								Keep subject lines under 50 characters and create urgency or
								curiosity.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start space-x-3">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-400">
								Tuesday-Thursday, 10 AM - 2 PM typically see the highest open
								rates.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start space-x-3">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-400">
								Over 60% of emails are opened on mobile devices. Keep content
								concise.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start space-x-3">
						...
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-400">
								Use action-oriented language and make buttons stand out
								visually.
							</p>
						</div>
					</div>
			...
			{activeTab === "campaigns" && (
				<div className="text-center py-12">
					...
					<p className="text-gray-600 dark:text-gray-400 mb-6">
						This section will be implemented with full campaign management
						features.
					</p>
