...
export const ThemedInput = React.forwardRef<HTMLInputElement, ThemedInputProps>(
	(
		...
		const baseClasses =
			"theme-input transition-all duration-200 focus:ring-2 focus:ring-blue-500/20";

		const variantClasses = {
			default: "border-gray-300 dark:border-gray-600 focus:border-blue-500",
			filled:
				"bg-gray-50 dark:bg-gray-700 border-transparent focus:bg-white dark:focus:bg-gray-800 focus:border-blue-500",
			outlined:
		...
		const getHorizontalPadding = () => {
			...
			const leftPad = leftIcon ? size.iconLeft : size.left;
			const rightPad = rightIcon || isPassword ? size.iconRight : size.right;
