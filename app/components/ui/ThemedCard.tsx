...
export const ThemedCard = ({
	...
	const variantClasses = {
		...
		elevated:
			"bg-white dark:bg-black border-0 shadow-lg dark:shadow-gray-900/20",
...
export const ThemedCardHeader = ({
	children,
	className = "",
}: ThemedCardHeaderProps) => {
	return (
		<div
			className={`border-b border-gray-200 dark:border-gray-700 pb-4 mb-6 ${className}`}
		>
			{children}
		</div>
	);
...
export const ThemedCardContent = ({
	children,
	className = "",
