			...
			<DialogContent className="sm:max-w-[700px] max-h-[90vh] p-0 gap-0 overflow-hidden bg-white dark:bg-black border-0 shadow-2xl">
				...
				<div className="relative px-8 py-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black border-b border-gray-100 dark:border-gray-900">
					...
					<div className="relative mt-5">
						<Search
							className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500"
							strokeWidth={2}
						/>
						<Input
					...
					{isLoadingPosts ? (
						<div className="flex flex-col items-center justify-center py-20">
							<div className="relative">
								...
								<Loader2
									className="w-12 h-12 absolute inset-0 animate-spin text-gray-900 dark:text-white"
									strokeWidth={2}
								/>
							</div>
						...
						<div className="flex flex-col items-center justify-center py-20">
							...
							<p className="text-sm text-gray-600 dark:text-gray-400 font-medium">
								{searchTerm
									...
									: "Không có bài viết nào để thêm"}
							</p>
							<p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
								{searchTerm
									? "Thử tìm kiếm với từ khóa khác"
									: "Tất cả bài viết đã được thêm vào series"}
							</p>
						</div>
					) : (
								...
								return (
									...
									>
										<div className="flex items-start gap-4">
											{/* Custom Checkbox */}
											<div
												className={`relative w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 mt-0.5 transition-all duration-200 ${
													isSelected
