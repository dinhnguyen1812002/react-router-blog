...
export const OAuthButtons = ({ onSuccess, onError, className = '' }: OAuthButtonsProps) => {
    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {providers.map((provider) => (
        <Button
          ...
          disabled={isLoading}
          className={`w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg font-medium transition-colors ${provider.bgColor} ${provider.textColor}`}
          variant="outline"
        >
