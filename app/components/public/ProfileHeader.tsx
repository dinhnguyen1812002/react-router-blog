...
export const ProfileHeader = (user: UserProfile) => {
	return (
		<header className="relative">
			{/* Cover gradient */}
			<div className="h-32 md:h-48 bg-gradient-to-br from-primary/20 via-accent/10 to-secondary" />

			<div className="container max-w-4xl mx-auto px-4">
				{/* Avatar positioned over cover */}
				<div className="relative -mt-16 md:-mt-20 mb-4 flex justify-center md:justify-start">
					<UserAvatar
				...
				<div className="text-center md:text-left animate-fade-in">
					...
					{/* Bio */}
					<p className="mt-4 text-foreground/90 text-lg max-w-2xl leading-relaxed">
						{user.bio}
					</p>

					{/* Meta info */}
					<div className="mt-4 flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm text-muted-foreground">
				...
				{/* Stats */}
				<div
					className="mt-6 border-t border-b border-border animate-slide-up"
					style={{ animationDelay: "0.2s" }}
				>
					<ProfileStats articles={100} followers={100} following={1000} />
				</div>
			</div>
		</header>
	);
