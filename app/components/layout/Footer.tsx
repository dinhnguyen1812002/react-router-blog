				...
				<div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-20">
					<div className="col-span-2">
						...
						<p className="text-slate-600 dark:text-slate-300 max-w-xs mb-8">
							Building the most beautiful, human-centric publishing platform on
							the web.
						</p>
						<div className="flex gap-4">
							<a
								href="#"
								className="p-2 bg-white dark:bg-slate-900 rounded-lg text-slate-400 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 shadow-sm hover:shadow transition-all"
							>
								<Twitter size={20} />
							</a>
							<a
					...
					<div>
						<h5 className="font-bold mb-6 text-slate-900 dark:text-slate-50">
							Product
						</h5>
